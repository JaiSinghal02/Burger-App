...
const burger = (props)=>{
    let cheese=[]
    for(var i=0;i<props.val[1];++i) cheese.push(<BurgerIngredients ing="cheese" />)
    let salad=[]
    for(i=0;i<props.val[2];++i) cheese.push(<BurgerIngredients ing="salad" />)
    let pickle=[]
    for(i=0;i<props.val[3];++i) cheese.push(<BurgerIngredients ing="pickle" />)
    let patty=[]
    for(i=0;i<props.val[0];++i) cheese.push(<BurgerIngredients ing="patty" />)
